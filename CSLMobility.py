...
strFilename = '/home/p17992pt/csf4_scratch/CSLTJMobility/Axis111/Sigma7_7_49/Temp500/u025/'
def VolumeRateChange(strDirectory, intLow,intHigh,intStep):
    lstVolume = []
    lstTime = []
...
for k in lstFilenames:
    lstTime,lstVolume = VolumeRateChange(strFilename + str(k) + '/', 1000, 50000, 1000)
    np.savetxt(strFilename + str(k) + '/Volume' + str(k) + '.txt', np.array([np.array(lstTime),np.array(lstVolume)]))
